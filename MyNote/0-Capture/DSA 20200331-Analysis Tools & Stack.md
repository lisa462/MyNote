...
![[Pasted image 20240111203452.png]]
表格 y時間/空間 = 資料量 + n基底

## Stack 堆疊 [02]()
### intuition
把資料疊上去，像是餐廳的餐盤，在電腦語言中，一般應用在限制和**延後執行**。
特徵，**最後進去的資料，會是最先被拿出來的**
### A Simple Application-Parentheses Balancing
寫編譯器程式的時候常用到。
Check-檢查編譯器的Code是否正確-> 每個函數的括號是否有一一對應。
目的：解決括號平衡的問題
**解決法：左括號push,右括號pop**![[Pasted image 20240111205351.png]]

### System Stack![[Pasted image 20240111205800.png]][03](https://youtu.be/-1FYYVpgyUo?list=PLXVfgk9fNX2Kda9rttSvGROCtRQ3Sb8bA&t=9107)
疊在一起可能衍伸的問題? 比如偷看下面的草稿紙
### Implementation 執行
Stack 要怎麼執行?
**Stacks Implementation on Array**
